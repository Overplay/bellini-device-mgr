...
(function ( window, angular, undefined ) {
     ...
     *          });
            ...
            /**
             *
             * Provides a UIB  from a list of Strings and a list of already selected strings.
             * Returns the result promise.
             *
             * Usage:  uibHelper.selectMultipleListModal("My Title", "Body Text",
             *  ['Apple','Banana','Grape','Peach'],['Apple', 'Banana'])
             *          .then( function(newChoices){
             *              // do something with newChoices
             *          });
             *
             * @param title
             * @param body
             * @param choiceArray [ field1, field2, ... ]
             * @param currentChoices [] or [ alreadychosen ]
             * @returns {*}
             */
            service.selectMultipleListModal = function ( title, body, choiceArray, currentChoices ) {

                var modalInstance = $uibModal.open( {
                    templateUrl: 'selectlistmultimodal.template.html',
                    controller:  function ( $scope, $uibModalInstance, params ) {
                        ...
                        $scope.modalUi = {
                            ...
                            currentChoices: params.currentChoices,
                            showChoice:     !params.body
                        };

                        $scope.ok = function () {
                            $uibModalInstance.close( $scope.modalUi.currentChoices );
                        }
                        ...
                        $scope.isSelected = function ( index ) {
                            return _.indexOf($scope.modalUi.currentChoices, params.choices[index]) >= 0;
                        }

                        $scope.select = function(index){
                            if ($scope.isSelected(index)){
                                // remove
                                $scope.modalUi.currentChoices = _.without($scope.modalUi.currentChoices, params.choices[index]);
                            } else {
                                $scope.modalUi.currentChoices.push(params.choices[index]);
                            }
                        }
                    ...
                    resolve:     {
                        params: function () {
                            return { title: title, body: body, choices: choiceArray, currentChoices: currentChoices };
                        }
                    }
                } );
     ...
     *          });
             ...
             * @returns {*}
             */
            service.stringEditModal = function ( title, body, string2Edit, placeholder, useTextArea ) {
                ...
                var modalInstance = $uibModal.open( {
                    ...
                    controller:  function ( $scope, $uibModalInstance, params ) {
                        ...
                        $scope.modalUi = {
                            ...
                            textarea:    params.useTextArea || params.string2Edit.length > 30
                        };
                    ...
                    resolve:     {
                        params: function () {
                            return { title: title, body: body, string2Edit: string2Edit, placeholder: placeholder, useTextArea: useTextArea };
                        }
                    }
                } );
     ...
     *          });
                ...
                var modalInstance = $uibModal.open( {
                    ...
                    controller:  function ( $scope, $uibModalInstance, params ) {
                        ...
                        $scope.missingRequired = function () {
                            ...
                            params.fieldsArray.forEach( function ( field ) {
        ...
        .run( [ '$templateCache', function ( $templateCache ) {
            ...
            $templateCache.put( 'selectlistmodal.template.html', '<style>\n    .slm-pick-item {\n        color: teal;\n        padding: 10px 0 10px 5px;\n        margin-left: 0;\n    }\n\n    .slm-picked {\n        background: #696969;\n        color: white;\n        transition: all 0.5s;\n    }\n\n    .slm-no-num {\n        list-style-type: none;\n        padding: 10px;\n    }\n</style>\n\n<div class="modal-header">\n    <h3 class="modal-title">{{ modalUi.title }}</h3>\n</div>\n<div class="modal-body" ng-show="showChoice">\n    {{ modalUi.choices[modalUi.currentChoice] }}\n</div>\n<div class="modal-body" ng-hide="showChoice">\n    {{ modalUi.body }}\n</div>\n<ol class="slm-no-num" style="margin: 10px; border: 1px solid #cacaca;">\n    <li ng-repeat="choice in modalUi.choices track by $index" class="slm-pick-item"\n        ng-class="{ \'slm-picked\': modalUi.currentChoice==$index}"\n        ng-click="modalUi.currentChoice = $index">{{ choice }}</li>\n</ol>\n\n\n<div class="modal-footer">\n    <button class="btn btn-primary" type="button" ng-click="ok()">OK</button>\n    <button class="btn btn-warning" type="button" ng-click="cancel()">Cancel</button>\n</div>' );
            $templateCache.put( 'selectlistmultimodal.template.html', '<style>\n    .slm-pick-item {\n        color: teal;\n        padding: 10px 0 10px 5px;\n        margin-left: 0;\n    }\n\n    .slm-picked {\n        background: #696969;\n        color: white;\n        transition: all 0.5s;\n    }\n\n    .slm-no-num {\n        list-style-type: none;\n        padding: 10px;\n    }\n</style>\n\n<div class="modal-header">\n    <h3 class="modal-title">{{ modalUi.title }}</h3>\n</div>\n<div class="modal-body" ng-show="showChoice">\n    {{ modalUi.choices[modalUi.currentChoice] }}\n</div>\n<div class="modal-body" ng-hide="showChoice">\n    {{ modalUi.body }}\n</div>\n<ol class="slm-no-num" style="margin: 10px; border: 1px solid #cacaca;">\n    <li ng-repeat="choice in modalUi.choices track by $index" class="slm-pick-item"\n        ng-class="{ \'slm-picked\': isSelected($index)}"\n        ng-click="select($index)">{{ choice }}</li>\n</ol>\n\n\n<div class="modal-footer">\n    <button class="btn btn-primary" type="button" ng-click="ok()">OK</button>\n    <button class="btn btn-warning" type="button" ng-click="cancel()">Cancel</button>\n</div>' );
            $templateCache.put( 'stringeditmodal.template.html', '<div class="modal-header">\n    <h3 class="modal-title">{{ modalUi.title }}</h3>\n</div>\n<div class="modal-body">\n    <p>{{ modalUi.body }}</p>\n    <input ng-if="!modalUi.textarea" class="form-control input-lg" type="text" ng-model="modalUi.editString" placeholder="{{ modalUi.placeholder }}">\n    <textarea ng-if="modalUi.textarea" class="form-control" ng-model="modalUi.editString" rows="8"\n                  placeholder="{{ modalUi.placeholder }}"></textarea>\n</div>\n\n<div class="modal-footer">\n    <button class="btn btn-primary" type="button" ng-click="ok()">OK</button>\n    <button class="btn btn-warning" type="button" ng-click="cancel()">Cancel</button>\n</div>' );
        } ] )
